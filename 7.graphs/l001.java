...
public class l001 {
    ...
    public static void isbipartite(ArrayList<Edge>[] graph,int src,int[] vis)
    {
        LinkedList<Integer> que = new LinkedList<>();
        que.addLast(src);
        ...
        if(!isCycle) System.out.println("Bipartite with no cycle");
        else {
            if(isbipartite) System.out.println("Bipartite with even Length cycle");
            
            else {
                System.out.println("Non-Bipartite with Odd  Length cycle");
            }
        }
